...
SECRET_KEY = 'django-insecure-uswncft)#untzru(!*e%)dx3$b(k2&@$ui+z0ds9r08nzndos*'
...
EMAIL_HOST_USER = 'devcryptoproject@gmail.com'
EMAIL_HOST_PASSWORD = 'gelhxjazfmpinusu'
EMAIL_PORT =587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/"cryptoapp/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
