    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_doc', models.ImageField(blank=True, upload_to='user_document_verification')),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('verified', models.BooleanField(default=False)),
                ('coin', models.ManyToManyField(blank=True, related_name='watchlist_coins', to='cryptoapp.coin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.FloatField()),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('coin', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='portfolio_coins', to='cryptoapp.coin')),
